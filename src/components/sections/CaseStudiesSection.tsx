    ...
    <section className="bg-primary py-24 text-primary-foreground md:py-32">
      <div className="container">
        <div className="mx-auto max-w-2xl text-center">
          ...
          <h2 className="mt-4 font-display text-3xl font-bold md:text-[2.5rem] leading-tight">
            Bewezen bij toonaangevende organisaties
          </h2>
          <p className="mt-5 text-lg text-primary-foreground/55">
            Een selectie van succesvolle plaatsingen.
          </p>
        </div>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {cases.map((c) => (
            <div
              key={c.client}
              className="group rounded-2xl border border-primary-foreground/8 bg-primary-foreground/[0.04] p-8 transition-all duration-300 hover:border-primary-foreground/15 hover:bg-primary-foreground/[0.07]"
            >
              ...
              <div className="mt-4 space-y-3 border-t border-primary-foreground/8 pt-4">
                <p className="text-sm leading-relaxed text-primary-foreground/45">
                  <span className="font-semibold text-primary-foreground/65">Uitdaging:</span>{" "}
                  {c.challenge}
                </p>
                <p className="text-sm leading-relaxed text-primary-foreground/45">
                  <span className="font-semibold text-accent">Resultaat:</span>{" "}
                  {c.result}
                </p>
              </div>
            </div>
