...
const vacancies = [
  { title: "Chief Technology Officer", company: "TechNova", location: "Amsterdam", type: "Fulltime", level: "C-level", industry: "Tech / SaaS", posted: "2 dagen geleden", urgent: true },
  { title: "VP Operations", company: "MAS Aviation", location: "Schiphol", type: "Fulltime", level: "VP", industry: "Luchtvaart", posted: "5 dagen geleden", urgent: false },
  { title: "Chief Financial Officer", company: "FinancePro Group", location: "Rotterdam", type: "Fulltime", level: "C-level", industry: "Finance", posted: "1 week geleden", urgent: true },
  { title: "Head of People & Culture", company: "Vertrouwelijk", location: "Utrecht", type: "Fulltime", level: "Director", industry: "Retail", posted: "3 dagen geleden", urgent: false },
  { title: "Managing Director DACH", company: "Vertrouwelijk", location: "Amsterdam / München", type: "Fulltime", level: "C-level", industry: "Industrieel", posted: "1 dag geleden", urgent: true },
  { title: "Director of Engineering", company: "ScaleUp B.V.", location: "Eindhoven", type: "Fulltime", level: "Director", industry: "Tech / SaaS", posted: "4 dagen geleden", urgent: false },
  { title: "Interim CFO", company: "Vertrouwelijk", location: "Den Haag", type: "Interim", level: "C-level", industry: "Publieke sector", posted: "6 dagen geleden", urgent: false },
  { title: "Commercial Director Benelux", company: "Vertrouwelijk", location: "Amsterdam", type: "Fulltime", level: "Director", industry: "FMCG", posted: "2 dagen geleden", urgent: false },
];
        ...
        <section className="relative overflow-hidden bg-primary py-24 md:py-32">
          ...
          <div className="container relative z-10">
            <ScrollReveal className="mx-auto max-w-3xl text-center">
              <span className="text-xs font-bold uppercase tracking-[0.2em] text-accent">Vacatures</span>
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            ...
            <div className="mt-4 text-sm text-muted-foreground">
              {filtered.length} {filtered.length === 1 ? "positie" : "posities"} gevonden
            </div>

            <StaggerContainer className="mt-8 space-y-4" stagger={0.06}>
              {filtered.map((v, i) => (
                <StaggerItem key={`${v.title}-${i}`} variant="fade-up">
                  <Link to="/nl/contact" className="group flex flex-col gap-4 rounded-2xl border border-border bg-card p-6 transition-all duration-300 hover:border-accent/25 hover:shadow-lg md:flex-row md:items-center md:justify-between">
        ...
        <section className="relative overflow-hidden bg-accent py-20 md:py-24">
          ...
          <div className="container relative z-10 text-center">
            <ScrollReveal variant="scale-in">
              <h2 className="font-display text-3xl font-bold text-accent-foreground md:text-[2.5rem] leading-tight">Niet gevonden wat u zoekt?</h2>
              <p className="mx-auto mt-5 max-w-lg text-lg text-accent-foreground/80">Veel van onze opdrachten zijn vertrouwelijk. Neem contact op en wij matchen u met de juiste positie.</p>
              <div className="mt-10">
                <Button asChild size="lg" className="h-13 rounded-full bg-primary px-10 text-[15px] font-semibold text-primary-foreground shadow-lg hover:bg-primary/90 transition-all duration-300">
                  <Link to="/nl/contact">Open sollicitatie <ArrowRight className="ml-2 h-4 w-4" /></Link>
                </Button>
              </div>
            </ScrollReveal>
          </div>
