          ...
          <div className="container">
            <ScrollReveal className="mx-auto max-w-3xl">
              ...
              <div className="mt-6 space-y-4 text-[15px] leading-relaxed text-muted-foreground">
                ...
                <p>Bij One Time Recruit is assessment geen bijproduct, het is de kern van ons <Link to="/nl/diensten/executive-search" className="font-medium text-accent hover:underline">executive search</Link> proces. Elke kandidaat doorloopt een gestandaardiseerd, multi-source assessment dat competenties, <Link to="/nl/culture-fit-vs-culture-add" className="font-medium text-accent hover:underline">cultuurfit</Link>, leiderschapspotentieel en referenties combineert tot één integraal beeld.</p>
