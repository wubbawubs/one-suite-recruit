...
const milestones = [
  ...
  { year: "Q2 2025", title: "One Time Recruit", description: "Gestart met een missie: executive search met vaste prijzen, snelheid en totale transparantie." },
  ...
  { year: "Q4 2025", title: "One Group opgericht", description: "Uitbreiding naar een ecosysteem: One Rooted, One Source en KlikKlaarSEO onder één dak." },
...
const team = [
  ...
  { tag: "Directs", name: "Juliëtte Welten", role: "COO", bio: "Bureau manager en BI specialist. Het financiële en operationele geweten van One Time Recruit.", photo: teamJuliette, linkedin: "https://www.linkedin.com/in/juliette-welten-ab566061/" },
...
const NLOverOns = () => {
  return (
    <div className="min-h-screen">
      <PageMeta
        title="Over Ons, One Time Recruit"
        description="Leer meer over One Time Recruit: onze missie, waarden, team en de reis van startup tot marktleider in executive search."
        locale="nl_NL"
      ...
      <main>
          ...
          <div className="container relative z-10">
            <ScrollReveal className="mx-auto max-w-3xl text-center">
              ...
              <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-primary-foreground/55">
                One Time Recruit is opgericht vanuit de overtuiging dat executive search persoonlijker, transparanter en effectiever kan.
              </p>
            </ScrollReveal>
          </div>
        </section>
            ...
            <div className="grid items-center gap-16 lg:grid-cols-2">
              <ScrollReveal variant="slide-left">
                ...
                <div className="mt-8 grid grid-cols-3 gap-4">
                  ...
                  <div className="border-l border-border pl-4">
                    ...
                    <p className="mt-1 text-xs text-muted-foreground md:text-sm">Dagen tot shortlist</p>
                  </div>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal variant="slide-right" className="space-y-6">
                <div className="overflow-hidden rounded-2xl">
                  <img src={sfeerOverOns} alt="One Time Recruit team" className="h-auto w-full object-cover" />
                </div>
                <div className="rounded-2xl border border-border bg-muted/40 p-6 md:p-10">
                  <div className="flex h-16 w-16 items-center justify-center rounded-xl bg-accent/10">
                   ...
                   <h3 className="mt-6 font-display text-xl font-bold text-foreground md:text-2xl">Onderdeel van One Group</h3>
                  <p className="mt-4 text-[15px] leading-relaxed text-muted-foreground">
                    One Time Recruit maakt deel uit van One Group, een ecosysteem van gespecialiseerde recruitment- en HR-labels. 
        ...
        <TestimonialQuote
          quote="One Time combineert snelheid met kwaliteit. Binnen drie weken hadden wij de juiste kandidaat op gesprek."
          author="HR Director"
          company="Thales"
        />
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            <ScrollReveal className="mx-auto max-w-3xl text-center">
              ...
              <h2 className="mt-4 font-display text-3xl font-bold text-foreground md:text-[2.5rem] leading-tight">De mensen achter One Time Recruit</h2>
              <p className="mx-auto mt-5 max-w-xl text-lg text-muted-foreground">
                One Time Recruit is niet gebouwd door productmanagers die gokten op recruitmentproblemen. Het is gebouwd door operators die ze jarenlang hebben geleefd.
              </p>
            </ScrollReveal>
