...
const data: SpokePageData = {
  ...
  sections: [
    ...
    },
    {
      ...
      items: [
        "[CEO](/nl/ceo-recruitment) / Managing Director — €180.000-€400.000+ (afhankelijk van organisatieomvang)",
        "[CFO](/nl/cfo-recruitment) / [CTO](/nl/cto-cio-recruitment) / COO — €150.000-€300.000+",
        "[CHRO](/nl/chro-recruitment) / CCO / CRO — €130.000-€250.000+",
        "VP / [Director level](/nl/directie-werving) — €120.000-€200.000",
