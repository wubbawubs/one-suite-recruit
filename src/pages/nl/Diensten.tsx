...
const services = [
  {
    ...
    description: "Het vinden van de juiste professionals voor uw organisatie. Gericht, snel en met oog voor cultuurfit en lange-termijn match.",
    features: ["Mid- tot senior-level plaatsingen", "Shortlist binnen 18 dagen", "Cultuurfit-analyse", "Vaste prijs, geen verrassingen"],
    href: "/nl/diensten",
  },
  {
    icon: Search,
  ...
  },
  {
    ...
    description: "Direct beschikbare interim professionals voor kritische posities. Bewezen leiders die binnen dagen kunnen starten en direct impact maken.",
  ...
  },
  {
    ...
    features: ["Succesplanning", "Team-effectiviteitsanalyse", "Board advisory", "Organisatieontwikkeling"],
    href: "/nl/diensten",
  },
];
            ...
            <StaggerContainer className="grid gap-8 md:grid-cols-2 lg:grid-cols-3" stagger={0.1}>
              {services.map((s) => (
                <StaggerItem key={s.title} variant="fade-up">
                  <div className={`group relative flex h-full flex-col overflow-hidden rounded-2xl border transition-all duration-300 hover:shadow-xl hover:shadow-accent/5 hover:-translate-y-1 ${
