...
import { Users, Target, BarChart3, Briefcase, ArrowRight, Crown, Settings, ShieldCheck } from "lucide-react";
...
const NLDienstenHub = () => {
  return (
    <div className="min-h-screen">
      <PageMeta
        title="Alle Diensten & Pagina's | One Time Recruit"
        description="Overzicht van alle diensten en pagina's van One Time Recruit. Van executive search tot assessment, van leadership advisory tot recruitment operating model."
        locale="nl_NL"
      ...
      <div className="container">
        <Breadcrumbs items={[{ label: "Home", href: "/nl" }, { label: "Alle diensten" }]} />
      </div>
      <main>
        {/* Hero */}
