...
import { ArrowRight, Users, Target, Clock, Shield, BarChart3, Award } from "lucide-react";
...
const deliverables = [
  { icon: Users, title: "Dedicated Talent Pool", description: "An exclusive shortlist of qualified candidates, curated specifically for your vacancy." },
  { icon: BarChart3, title: "Competency Assessment", description: "Competency-based evaluation using STAR methodology, cultural fit analysis and potential assessment." },
  { icon: Clock, title: "Fast Shortlist", description: "Average 18 working days from intake to shortlist, without compromising on quality." },
  { icon: Shield, title: "Placement Guarantee", description: "Placement guarantee with a free restart if the match doesn't work out." },
  { icon: Target, title: "Weekly Reporting", description: "Transparent updates on progress, pipeline and market insights throughout the process." },
  { icon: Award, title: "Onboarding Support", description: "100-day guidance after placement for a successful start." },
];

const processSteps = [
  { step: "01", title: "Intake & Profile Definition", duration: "Day 1-2", description: "In-depth discussion about your organisation, culture, challenges and the ideal candidate profile." },
  { step: "02", title: "Market Analysis & Sourcing", duration: "Day 3-8", description: "Proactive search through our network, combined with targeted market outreach." },
  { step: "03", title: "Assessment & Shortlist", duration: "Day 9-14", description: "Competency-based interviews, STAR assessments and cultural fit analysis." },
  { step: "04", title: "Presentation & Selection", duration: "Day 15-18", description: "Detailed candidate profiles with our recommendation and interview guidance." },
  { step: "05", title: "Placement & Onboarding", duration: "Post-selection", description: "Negotiation, contract guidance and 100-day onboarding programme." },
];

const faqs = [
  { q: "What positions does Recruitment & Selection cover?", a: "Our recruitment service is designed for mid- to senior-level positions: team leads, department heads, specialists and management roles across all industries." },
  { q: "How quickly will I receive candidates?", a: "Average 18 working days from intake to a shortlist of 3-5 qualified candidates." },
  { q: "What does recruitment cost?", a: "We work with transparent fixed fees instead of percentage-based charges. No hidden costs, no surprises." },
  { q: "Is there a guarantee?", a: "Yes, we offer a placement guarantee. If the hire doesn't work out, we restart the search free of charge." },
  { q: "Which regions do you cover?", a: "We operate in the Netherlands and Germany, with a network of over 7,500 professionals." },
];

export default function ENRecruitmentSelection() {
  return (
    <div className="min-h-screen">
      <PageMeta
        title="Recruitment & Selection — Find the Right Professionals | One Time Recruit"
        description="Targeted recruitment for mid- to senior-level positions. Fixed fee, shortlist in 18 days, cultural fit analysis. Discover our proven methodology."
        locale="en_US"
        jsonLd={{
      ...
      <div className="container">
        <Breadcrumbs items={[{ label: "Home", href: "/en" }, { label: "Services", href: "/en/services" }, { label: "Recruitment & Selection" }]} />
      </div>
      <main>
        <section className="relative overflow-hidden bg-primary py-20 md:py-28 lg:py-36">
          ...
          <div className="container relative z-10">
            <ScrollReveal className="mx-auto max-w-3xl text-center">
              <span className="text-xs font-bold uppercase tracking-[0.2em] text-accent">Recruitment & Selection</span>
              <h1 className="mt-4 font-display text-3xl font-bold leading-[1.08] text-primary-foreground md:text-5xl lg:text-[3.5rem]">
                Finding the right professionals <span className="text-accent">for your organisation</span>
              </h1>
              <p className="mx-auto mt-6 max-w-xl text-lg leading-relaxed text-primary-foreground/60">
                Targeted recruitment for mid- to senior-level positions. Fixed fee, shortlist in 18 days, with a focus on cultural fit and long-term match.
              </p>
        ...
        <section className="py-16 md:py-24">
          <div className="container">
            <ScrollReveal className="mx-auto max-w-2xl text-center">
              ...
              <h2 className="mt-4 font-display text-2xl font-bold text-foreground md:text-4xl">Concrete deliverables, no vague promises</h2>
            </ScrollReveal>
        ...
        <section className="relative overflow-hidden bg-accent py-14 md:py-20">
          <div className="container relative z-10 text-center">
            <ScrollReveal variant="scale-in">
              <h2 className="font-display text-3xl font-bold text-accent-foreground md:text-[2.5rem] leading-tight">Ready to find the right candidates?</h2>
